...
public class BucketBehavior : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (pipe3.GetComponent<ValveBehavior>().correctPosition == 1 || pipe3.GetComponent<WaterPipeBehavior>().correctPosition == 1)
        {
            redCheck = true;
        ...
        if (pipe4.GetComponent<ValveBehavior>().correctPosition == 1 || pipe4.GetComponent<WaterPipeBehavior>().correctPosition == 1)
        {
            yellowCheck = true;
